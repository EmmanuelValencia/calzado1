    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-dark bg-navbar navbar-dark bg-dark" id="mainNav">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="usuario2">VOLVER A LA PAGINA PRINCIPAL</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="user/profile">VER PERFIL</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="usuario2dos">TODOS LOS ARTICULOS</a></li>
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">CARRITO</h2>
                <br>
                <br>
                <br>
                <br>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- <a class="btn btn-primary" data-bs-dismiss="modal"  href="carrito">
